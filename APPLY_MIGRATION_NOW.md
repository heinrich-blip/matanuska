...
Your app is failing because the `wialon_vehicles` table doesn't exist in your Supabase database.
...
The load management page should now work!

## What This Does

- ✅ Creates `wialon_vehicles` table for GPS-tracked vehicles
- ✅ Fixes foreign key constraint on `loads` table
- ✅ Sets up proper permissions (RLS policies)
- ✅ Enables your app to assign loads to vehicles

## After Applying

1. Refresh your browser
2. Go to Load Management
3. Click "Assign" on a load
4. You should see vehicles available for assignment
5. Edit and assignment should now work!
